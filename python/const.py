...
SOLR_SCHEMA_FIELD_NAMES = ("Path", "From", "Newsgroups", "Subject", "Message-ID", "Date", "Organization", "Lines", "Sender", "References", "Xref", "Article-I.D.", "Expires", "Followup-To", "Keywords", "Distribution", "Approved", "Supersedes", "Originator", "Content-Type", "X-Newsreader", "Summary")
